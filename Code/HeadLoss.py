...
velocity = float(input("What is the velocity of water in the effluent piping, in units of millimeters per second?\n"))*u.mm/u.s

density_water = 997*u.kg/(u.m**3)
g = 9.8 *u.m/(u.s**2)
pipe_diameter = float(input("What is the diameter of the effluent piping, in units of millimeters?\n"))*u.mm
